...
import java.lang.Override;import java.lang.String;import java.lang.Void;import java.net.Socket;
...
public class AsyncClient extends AsyncTask<Void, Void, byte[]> {
    ...
    public AsyncClient(String addr, int port, String job, byte[] data) {
